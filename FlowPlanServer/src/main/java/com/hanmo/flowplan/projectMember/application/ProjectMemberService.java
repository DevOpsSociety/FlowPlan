...
public class ProjectMemberService {
  ...
  @Transactional
  public void updateMemberRole(Long projectId, Long PmemberId, String ownerId, ProjectRole newRole) {
    ...
    // 2. 대상 멤버 조회
    ProjectMember targetMember = projectMemberRepository.findById(PmemberId)
        .orElseThrow(() -> new BusinessException(ErrorCode.USER_NOT_FOUND, "멤버를 찾을 수 없습니다."));
